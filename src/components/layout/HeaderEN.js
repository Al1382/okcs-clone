...
const HeaderEN = () => {
  ...
  const buttons = [
    ...
    { image: "/icons/products.png", text: "Products", link: "/ProductsListPageEN" },
  ];
  ...
  const handleLanguageToggle = () => {
    ...
    if (language === "fa") {
      navigate("/HomeEN"); // Redirect to the English home page
    } else {
      navigate("/Home"); // Redirect to the Persian home page
    }
  };
