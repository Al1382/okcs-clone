...
const Counter = () => {
  const dataTopRow = [
    { title: "محصولات", value: 3200, img: "/icons/icon1.png", showPlus: true },
    { title: "کارکنان", value: 21000, img: "/icons/icon2.png", showPlus: true },
    { title: "شعب", value: 4000, img: "/icons/icon3.png", showPlus: true },
  ];

  const dataBottomRow = [
    { title: "استان", value: 31, showPlus: false },
    { title: "شهر", value: 686, showPlus: false },
  ];
          ...
          <Grid container spacing={2} justifyContent="center">
            {dataBottomRow.map((item, index) => (
              <Grid item xs={12} key={index} sx={{ textAlign: "center" }}>
                ...
                >
                  {toPersianNumber(counts[index + dataTopRow.length])}
                </Typography>
              </Grid>
            ))}
          </Grid>
